            ...
            if ((userLogin != "") || (userPassword != "")) {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        permCreateLocation = Convert.ToBoolean(permissionRDR[27]); // Set variable equal to item in reader
                        permCreateServer = Convert.ToBoolean(permissionRDR[28]); // Set variable equal to item in reader
