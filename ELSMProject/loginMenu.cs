...
namespace ELSM_Project
{
    public partial class loginMenu : Form
    {
        ...
        //Define functions to encrypt and decrypt data that is required to be two-way for use in SSH connection. Credit for the creation of this function goes to https://gist.github.com/odan
